...
public class OrderService : IOrderService
{
    ...
    public OrderService(IOrderRepo orderRepo, IOrderItemRepo orderItemRepo, IMapper mapper, ILogger<OrderService> logger, IProductRepo productRepo)
    {
    ...
    public (bool, string?) ChangeOrderStatus(int orderId, string newStatus, string modifiedBy)
    {
        try
        {
            ...
            if (newStatus == "Cancelled")
            {
                ...
                {
                    _productRepo.IncreaseStock(item.ProductId, item.Quantity);
                }
            }
